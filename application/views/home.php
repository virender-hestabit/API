...
$(document).on("keyup","#search-box",function(){
        ...
        var url = "<?php echo base_url('/home/search_disease');?>";
        $.ajax({
              url : url,
              type : 'POST',
...
function selectDisease(val) {
	var disId = $(val).attr("data-id");
	$("#search-box").val(val.id);
    var url = "<?php echo base_url('disease/detail/'); ?>"+disId;
    $('#queryStrUrl').attr('href',url)
