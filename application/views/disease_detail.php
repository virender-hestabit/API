  ...
  <?php } ?>
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home" >
          ...
          <div class="form-group" align="center" >
            <select class="form-control" name="dies_status" required>
...
<?php require('footer.php'); ?>
    ...
    <script type="text/javascript">
        ...
        //Status handler
          function Status(statusId,dies_id){ 
              // var statusIds = $(statusId).val();
            if(confirm("What you want to change the status!")){
                var url = "<?php echo base_url('/admin/update_dies_status');?>";
                $.ajax({
                      url : url,
                      type : 'POST',
                      data : {statusId:statusId,dies_id:dies_id},
